        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <p className="max-w-[600px] mb-9 text-white/80">
              Passionate Senior Highschool student at Fawe Girls School, 
              with a track record of: Leadership, public Speaking and innovative software development. I blend academic 
              rigor with practical experience to create impactful solutions, 
