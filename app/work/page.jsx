...
const projects = [
  {
    ...
    github: "https://github.com/germainhirwa/link-saver/tree/master",
  },
  {
    num: "02",
    category: "Machine Learning Game",
    title: "Rock-Paper-Scissors with AI",
    description: "A fun game of Rock-Paper-Scissors that uses computer vision, hand detection via a webcam and machine learning to predict and play against the user.",
    stack: [{ name: "Python" }, { name: "OpenCV" }, { name: "MediaPipe" }],
    image: "/assets/rock_paper_scissors.png",
    live: "",
    github: "https://github.com/germainhirwa/GestureGauntlet",
  },
  {
    num: "03",
